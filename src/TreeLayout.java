...
public class TreeLayout extends PipeBase implements Layout {
    ...
    protected void computePositions() {
        ...
        hi.x = hi.y = Double.MAX_VALUE;
        lo.x = lo.y = Double.MIN_VALUE;
    ...
    protected void renderBox(Box box) {
        ...
        if (box.parent != null) {
            ...
            switch (renderingType) {
                case VERTICAL:
                    sx = box.level;//TODO sx = 1 / (double) parentBox.size();
                    sy = box.level;//TODO sy = 1 / Math.pow(2, box.level);
                    break;
                case DISK:
                case HORIZONTAL:
        ...
        box.scale(1, 1);//TODO box.scale(sx, sy);
        ...
        if (box.parent != null) {
            ...
            switch (renderingType) {
                case VERTICAL:
                    dx -= box.width / 4;//TODO dx -= parentBox.width / 2;
                    dy -= parentBox.height;//TODO dy += parentBox.height / 2;
                    break;
                case DISK:
                case HORIZONTAL:
